...
class ElectricCar implements Vehicle {
  assemble(): void {
    console.log('Assembling an %celectric car',COLORS.blue);
  }
}

class GasCar implements Vehicle {
  assemble(): void {
    console.log('Assembling a %ccombustion car',COLORS.red);
  }
}

class ElectricEngine {
  start():void{
    console.log('Starting %celectric engine',COLORS.cyan);
  }
}

class GasEngine {
 start():void{
    console.log('Starting %ccombustion engine',COLORS.yellow);
  }
}
