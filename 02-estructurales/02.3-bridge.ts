...
function main() {
    ...
    const chanels=[new EmailChannel(),new SMSChannel(),new PushNotificationChannel()];

    const alert = new AlertNotification(chanels);
    alert.notify("Someone in front of your house!");
    console.log("\n");
